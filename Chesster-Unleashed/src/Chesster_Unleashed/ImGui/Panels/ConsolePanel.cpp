...
namespace Chesster
{
	...
	void ConsolePanel::OnImGuiRender(const char* title, bool* p_open)
	{
		...
		if (ImGui::InputText("Input", InputBuffer.data(), InputBuffer.size(), input_text_flags, &TextEditCallbackStub, (void*)this))
		{
